...
type DataTableProps<TData, TValue> = {
    ...
    tabs?: TabFilter[];
    defaultTab?: string;
    // New prop to enable persistent page size with optional table identifier
    persistPageSize?: boolean | string;
    // Default page size (fallback when no stored value exists)
...
export function DataTable<TData, TValue>({
    ...
    // Handle page size changes and persist if enabled
    useEffect(() => {
